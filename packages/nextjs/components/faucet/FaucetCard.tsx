    ...
    <div className="rounded-xl border border-base-300 bg-base-100 p-6">
      ...
      {isConnected && address ? (
        <div className="space-y-2">
          <p className="text-xs text-base-content/60 uppercase tracking-wider">Connected</p>
          <Address
            address={address}
            chain={baseSepolia}
        ...
        <div className="flex flex-col items-start gap-3">
          <p className="text-sm text-base-content/80">Connect your wallet to request testnet ETH.</p>

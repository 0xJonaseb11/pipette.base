    ...
    <div className="min-h-[80vh] max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-6 text-base-content/90">
        <section>
          ...
          <p>
            Pipette powers newbie African Web3 with Base Sepolia testnet tokens. We distribute small amounts of
            Base Sepolia ETH to developers for building and testing, at no cost.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            To claim, you must connect a wallet, link GitHub, and meet our anti-sybil score thresholds. Users
            with low scores may be pending review or restricted. We reserve the right to block wallets that
